...
@section('cms_header')
@include('utils.cms_header',['url' => 'menu' , 'title' => 'Menu'])
@endsection
{{------------------------------}}
@section('cms_content')
...
<a href="{{url('cms/menu/create')}}" class="btn btn-primary btn-icon-split btn-lg my-2">
...
<table class="table table-bordered dataTable mx-auto text-center " id="dataTable"
cellspacing="0" role="grid"
aria-describedby="dataTable_info" style="width: 80%; ">
<thead class="">
<tr role="row">
<th class="sorting_asc" tabindex="0" aria-controls="dataTable"
rowspan="1" colspan="1" aria-sort="ascending"
aria-label="Name: activate to sort column descending"  style="width:50%;">Menu
Link
</th>
<th class="text-center"  tabindex="0" aria-controls="dataTable"
rowspan="1" colspan="1"
aria-label="Position: activate to sort column ascending"
style="width:50%;">Operations</th>
...
<tr>
<td class="font-weight-bold">{{$menu_item['link']}}
</td>

<td class="text-center">
<a href="{{url('cms/menu/' . $menu_item['id'] . '/edit')}}"><i class="fas fa-edit"></i> Edit</a>
|
<a href="{{$menu_item['link']}}" data-toggle="modal"
data-target="#deleteModal-{{$menu_item['id']}}">
...
<div class="modal fade" id="deleteModal-{{$menu_item['id']}}"
...
want to
delete this menu link.</div>
<div class="modal-footer">
<form
action="{{url('cms/menu/' . $menu_item['id'])}}"
method="POST">
@csrf()
{{ method_field('DELETE')}}
...
href="{{ url('cms/menu/' . $menu_item['id'])}}"></a>
</form>
</div>
</div>
</div>
