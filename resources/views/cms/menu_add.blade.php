...
@section('cms_header')
@include('utils.cms_header',['url' => 'menu/create','title' => '+ Add New Menu Link'])
@endsection
{{------------------------------}}
@section('cms_content')
...
<input value="{{old('link')}}" type="text" name="link" id="link" class="form-control origin-text " placeholder="* Link">
...
<input value="{{old('title')}}" type="text" name="title" id="title" class="form-control target-title " placeholder="* Title" style="text-transform: capitalize;">
...
<div class="form-group add-input-buttons ">



<a href="{{url('cms/menu')}}" class="btn btn-secondary mr-2">Cancel</a>
<input type="submit" value="Save Menu Link" class="btn btn-primary " name="submit"> <span class="icon text-white-50">
