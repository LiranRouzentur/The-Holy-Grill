...
@section('cms_header')
@include('utils.cms_header',['url' => 'categories/create','title' => '+ Add New Category'])
@endsection
{{------------------------------}}
@section('cms_content')
...
<div class="row">
<div class="col">
<form  action="{{url('cms/categories')}}" runat="server" method="POST" autocomplete="off" novalidate="novalidate" enctype="multipart/form-data">
@csrf()
