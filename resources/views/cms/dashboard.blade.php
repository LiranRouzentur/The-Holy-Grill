...
@section('cms_header')
@include('utils.cms_header',['url' => 'dashboard','title' => 'Dashboard'])
@endsection
{{------------------------------}}
@section('cms_content')
...
<div class="container-fluid">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Amount Of Products</div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
  ...
  <div class="row">
    ...
    <div class="col-xl-8 col-lg-8 col-md-12">
      <div class="card shadow2 mb-4" >
        <!-- Card Header - Dropdown -->
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Earnings Overview</h6></div>
        <!-- Card Body -->
        <div class="card-body">
          <div class="chart-area">
            <canvas id="myAreaChart"></canvas></div>
             <div class="card-footer small text-muted">Lest Update : &nbsp;   {{ date('H:i:s || d-m-Y') }}</div>
      </div>
      </div>
      </div>
